Job Description
----------------
	Gather occurrences of system event 7034 for cluster servers

Step name:
--------
	Wrapper-EventLogs.ps1

Command: (https://github.com/imajaydwivedi/SQLDBATools/blob/master/Cmdlets/Wrapper-EventLogs.ps1)
--------
