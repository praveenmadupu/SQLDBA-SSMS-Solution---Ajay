...
CREATE DATABASE DBA
-- ON  PRIMARY
--( NAME = N'DBA', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA.mdf' , SIZE = 500MB , FILEGROWTH = 200MB )
-- LOG ON 
--( NAME = N'DBA_log', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Log\DBA_log.ldf' , SIZE = 500MB , FILEGROWTH = 200MB )
GO

ALTER DATABASE DBA ADD FILEGROUP [fg_default]
GO
ALTER DATABASE DBA ADD FILE
	( NAME = N'DBA_fg_default', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_fg_default.ndf' , SIZE = 500MB , FILEGROWTH = 500MB )
...
GO
ALTER DATABASE DBA ADD FILE
	( NAME = N'DBA_1_fg_ci', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_1_fg_ci.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB ),
	( NAME = N'DBA_2_fg_ci', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_2_fg_ci.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB ),
	( NAME = N'DBA_3_fg_ci', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_3_fg_ci.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB ),
	( NAME = N'DBA_4_fg_ci', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_4_fg_ci.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB )
	TO FILEGROUP [fg_ci]
GO
...
GO
ALTER DATABASE DBA ADD FILE
	( NAME = N'DBA_1_fg_nci', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_1_fg_nci.ndf' , SIZE = 204800KB , FILEGROWTH = 204800KB ),
	( NAME = N'DBA_2_fg_nci', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_2_fg_nci.ndf' , SIZE = 204800KB , FILEGROWTH = 204800KB )
	TO FILEGROUP [fg_nci]
GO
...
GO
ALTER DATABASE DBA ADD FILE
	( NAME = N'DBA_1_fg_heap', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_1_fg_heap.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB )
...
GO
ALTER DATABASE DBA ADD FILE
	( NAME = N'DBA_1_fg_archive', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_1_fg_archive.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB ),
	( NAME = N'DBA_2_fg_archive', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_2_fg_archive.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB ),
	( NAME = N'DBA_3_fg_archive', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_3_fg_archive.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB ),
	( NAME = N'DBA_4_fg_archive', FILENAME = N'E:\MSSQL15.MSSQLSERVER\Data\DBA_4_fg_archive.ndf' , SIZE = 512000KB , FILEGROWTH = 512000KB )
