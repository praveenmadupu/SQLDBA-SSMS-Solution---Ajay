...
--	EXEC SQLDBATools..[usp_GetMail_4_SQLDBATools] @p_Option = 'VolumeInfo' ,@p_recipients = 'ajay.dwivedi@tivo.com;Nasir.Malik@tivo.com'
--	EXEC SQLDBATools..[usp_GetMail_4_SQLDBATools] @p_Option = 'BackupInfo' ,@p_recipients = 'ajay.dwivedi@tivo.com;Nasir.Malik@tivo.com'
--	EXEC SQLDBATools..[usp_GetMail_4_SQLDBATools] @p_Option = 'SecurityCheckInfo' ,@p_recipients = 'ajay.dwivedi@tivo.com;Nasir.Malik@tivo.com'; 
--	EXEC SQLDBATools..[usp_GetMail_4_SQLDBATools] @p_Option = 'AOReplicaInfo' ,@p_recipients = 'ajay.dwivedi@tivo.com;'; 
--	EXEC SQLDBATools..[usp_GetMail_4_SQLDBATools] @p_Option = 'AOReplicaIssuesInfo' ,@p_recipients = 'ajay.dwivedi@tivo.com;' ,@p_Verbose = 1
