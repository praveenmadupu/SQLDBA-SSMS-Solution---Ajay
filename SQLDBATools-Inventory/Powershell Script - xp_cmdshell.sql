...
EXEC @result = xp_cmdshell 'PowerShell.exe -noprofile -command "C:\Program` Files\WindowsPowerShell\Modules\SQLDBATools\Cmdlets\Wrapper-JAMSEntry.ps1"' ,no_output;  
