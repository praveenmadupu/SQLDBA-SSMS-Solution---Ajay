...
exec sp_trace_setevent @TraceID, 97, 5, @on; --Showplan All.LineNumber
exec sp_trace_setevent @TraceID, 97, 7, @on; --Showplan All.NTDomainName
exec sp_trace_setevent @TraceID, 97, 8, @on; --Showplan All.HostName
exec sp_trace_setevent @TraceID, 97, 64, @on; --Showplan All.SessionLoginName
exec sp_trace_setevent @TraceID, 97, 66, @on; --Showplan All.GroupID
exec sp_trace_setevent @TraceID, 97, 35, @on; --Showplan All.DatabaseName
exec sp_trace_setevent @TraceID, 97, 41, @on; --Showplan All.LoginSid
exec sp_trace_setevent @TraceID, 97, 49, @on; --Showplan All.RequestID
exec sp_trace_setevent @TraceID, 97, 50, @on; --Showplan All.XactSequence
exec sp_trace_setevent @TraceID, 97, 51, @on; --Showplan All.EventSequence
exec sp_trace_setevent @TraceID, 97, 60, @on; --Showplan All.IsSystem
exec sp_trace_setevent @TraceID, 97, 25, @on; --Showplan All.IntegerData
exec sp_trace_setevent @TraceID, 97, 26, @on; --Showplan All.ServerName
exec sp_trace_setevent @TraceID, 97, 27, @on; --Showplan All.EventClass
exec sp_trace_setevent @TraceID, 97, 28, @on; --Showplan All.ObjectType
exec sp_trace_setevent @TraceID, 97, 29, @on; --Showplan All.NestLevel
exec sp_trace_setevent @TraceID, 97, 34, @on; --Showplan All.ObjectName
exec sp_trace_setevent @TraceID, 97, 9, @on; --Showplan All.ClientProcessID
exec sp_trace_setevent @TraceID, 97, 10, @on; --Showplan All.ApplicationName
exec sp_trace_setevent @TraceID, 97, 11, @on; --Showplan All.LoginName
exec sp_trace_setevent @TraceID, 97, 12, @on; --Showplan All.SPID
exec sp_trace_setevent @TraceID, 97, 14, @on; --Showplan All.StartTime
exec sp_trace_setevent @TraceID, 97, 22, @on; --Showplan All.ObjectID
...
set @loginName = 'CORPORATE\vesta.amg.process';
