...
--	Rename Jobs and put 'DBA - ' in their names
exec msdb..sp_update_job @job_name = 'DatabaseBackup - SYSTEM_DATABASES - FULL'  
     ,@new_name = 'DBA - DatabaseBackup - SYSTEM_DATABASES - FULL',
     @enabled = 0;
GO
exec msdb..sp_update_job @job_name = 'DatabaseBackup - USER_DATABASES - FULL'  
     ,@new_name = 'DBA - DatabaseBackup - USER_DATABASES - FULL',
     @enabled = 0;
GO
exec msdb..sp_update_job @job_name = 'DatabaseBackup - USER_DATABASES - DIFF'  
     ,@new_name = 'DBA - DatabaseBackup - USER_DATABASES - DIFF',
     @enabled = 0;
GO
exec msdb..sp_update_job @job_name = 'DatabaseBackup - USER_DATABASES - LOG'  
     ,@new_name = 'DBA - DatabaseBackup - USER_DATABASES - LOG',
     @enabled = 0;
GO
exec msdb..sp_update_job @job_name = 'DatabaseIntegrityCheck - SYSTEM_DATABASES'  
     ,@new_name = 'DBA - DatabaseIntegrityCheck - SYSTEM_DATABASES',
     @enabled = 0;
GO
exec msdb..sp_update_job @job_name = 'DatabaseIntegrityCheck - USER_DATABASES'  
     ,@new_name = 'DBA - DatabaseIntegrityCheck - USER_DATABASES',
     @enabled = 0;
GO
exec msdb..sp_update_job @job_name = 'Output File Cleanup'  
     ,@new_name = 'DBA - Output File Cleanup',
     @enabled = 0;
GO
exec msdb..sp_update_job @job_name = 'CommandLog Cleanup'  
     ,@new_name = 'DBA - CommandLog Cleanup',
     @enabled = 0;
GO