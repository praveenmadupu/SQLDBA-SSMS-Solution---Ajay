...
from DBA.[dbo].[SQLTrace_Cosmo_Richmedia_Timeout] t left join sys.trace_events e on e.trace_event_id = t.EventClass
--where t.ApplicationName like '%Management Studio%'
--and DatabaseName in ('Stackoverflow')
--and HostName in ('BAN-1ADWIVEDI-L')
--and LoginName in ('sa')
...
set @path = 'E:\DBA\SQLTrace\BAN-1ADWIVEDI-L_10Sep2018_0143PM.trc'
